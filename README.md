...
每天北京时间 09:00 自动抓取 GitHub Trending 的日榜、周榜、月榜 Top 10，并把每个项目用很白话的中文解释后推送到 pushplus。
...
- 每个项目都会包含项目名、GitHub 跳转链接、作者简介、语言、热度，以及“小白解释”。
...
默认版本不需要任何 AI Key，完全靠规则生成通俗解释，优点是免费、稳定、不会泄露 token。
